...
$string['mousemotion'] = 'Mouse motion';
$string['mousescroll'] = 'Mouse scroll';
$string['keystroke'] = 'Keystroke';
$string['stylometry'] = 'Stylometry';
$string['downloadyourdata'] = 'Download your data.';
$string['numbiodatarows'] = 'Number of biodata rows';
$string['numbiodatarowsdesc'] = 'Number of biodata rows in the data download table.';
